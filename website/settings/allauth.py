...
# See documentation for Django’s session invalidation on password change. (Django 1.7+)
...
# A callable (or string of the form ‘some.module.callable_name’) that takes a user as its only argument and
# returns the display name of the user. The default implementation returns user.username.
